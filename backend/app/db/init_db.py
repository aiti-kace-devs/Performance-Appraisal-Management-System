...
def init_db(db: Session) -> None:
    ...
    "gender" : "Male" ,
    "position" : "HR" ,
    "user_id":"03e8beaa-ba9f-4192-b788-ffcff2cef450",
    "department_id":"03e8beaa-ba9f-4192-b788-ffcff2cef900",
    "grade": "50",
    ...
    try:
        data = StaffCreate(**payload)  #model class name
       
        print("data :", data)
        db_add = Staff(**payload)  #model class name
        db.add(db_add)
        db.commit()
        db.refresh(db_add)
